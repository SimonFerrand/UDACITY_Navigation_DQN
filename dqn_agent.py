...
TAU = 5e-4              # for soft update of target parameters # 1e-3+
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        self.optimizer = optim.Adam(self.qnetwork_local.parameters(), lr=LR)  # Adam, SGD=Stochastic Gradient Descent, Adagrad, RMSprop   
    ...
    def learn(self, experiences, gamma):
        ...
        loss.backward()
        self.optimizer.step()
        self.last_loss = loss.item() # Store the loss for future use
